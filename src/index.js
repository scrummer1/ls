...
function skipDefault(eventName, target) {
    target.addEventListener(eventName, function (ev) {ev.preventDefault()});
}
...
function once(target, fn) {
    let onceEvent = function (ev) {
        fn(ev);
        target.removeEventListener('click', onceEvent);
    }
    target.addEventListener('click', onceEvent);
}
